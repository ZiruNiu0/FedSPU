...
import numpy as np
from util import get_filters, get_parameters, set_filters, spu_aggregation, get_subnet, generate_subnet_ordered
...
class fjord_strategy(fl.server.strategy.FedAvg):
    ...
    def configure_evaluate(self, server_round: int, parameters, client_manager: ClientManager):
        ...
        for client in clients:
            ...
            rate = get_rate(cid)
            config = {}
            _, parameters = generate_subnet_ordered(self.global_model, rate)
