...
from util import get_filters, get_parameters, set_filters, spu_aggregation, generate_filters_random, parameters_to_ndarrays, get_subnet, get_neuron_sets, jaccard_distance
CHANNEL = 3
Batch = 128
CLASSES = 10
...
class fedmp_strategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_evaluate(self, server_round: int, results, failures):
        ...
        if self.min_available_clients_ <= 100 and server_round == 1:
           ...
           jdf.to_csv('jaccard_fedmp.csv', index=False)
